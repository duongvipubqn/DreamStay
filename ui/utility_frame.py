...
class UtilityFrame(ctk.CTkScrollableFrame):
    def __init__(self, master):
        ...
        ctk.CTkLabel(self, text="Tiện Ích & Dịch Vụ", font=("Georgia", 32, "bold"), text_color=COLOR_NAVY).pack(pady=30)
        ...
        utils = [
            ...
            ("🏋️", "Fitness Center", "Duy trì thói quen luyện tập với trung tâm thể hình hiện đại."),
        ...
        for i, (icon, name, desc) in enumerate(utils):
            ...
            ctk.CTkLabel(card, text=icon, font=("Segoe UI", 40)).pack(pady=10)
            ctk.CTkLabel(card, text=name, font=("Segoe UI", 18, "bold"), text_color=COLOR_NAVY).pack()
