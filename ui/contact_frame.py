...
class ContactFrame(ctk.CTkFrame):
    def __init__(self, master):
        ...
        ctk.CTkLabel(self, text="Liên Hệ Với Chúng Tôi", font=("Segoe UI", 32, "bold"), text_color=COLOR_TEXT).pack(
            pady=30)
        ...
        ctk.CTkLabel(self.left, text="Gửi Tin Nhắn", font=("Segoe UI", 20, "bold"), text_color=COLOR_TEXT).pack(pady=20)
